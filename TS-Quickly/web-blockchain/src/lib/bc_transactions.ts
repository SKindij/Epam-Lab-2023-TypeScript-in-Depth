// src/lib/bc_transactions.ts
// функція для генерації хешів
import { sha256 } from './universal_sha256.js';

// користувацький інтерфейс для транзакції
...
export class Blockchain {
  ...
  // геттер для усіх блоків чейну
  get chain(): Block[] {
    return [ ...this._chain ];
  }
  // геттер для всіх очікуючих транзакцій
