...
/*
// приклад використання умовного(conditional) типу:
const resultWhenTrue:string = update(true);
const resultWhenFalse:number = update(false);
console.log(`resultWhenTrue: ${resultWhenTrue} / resultWhenFalse: ${resultWhenFalse}`);
*/
